...
const userSchema = mongoose.Schema(
  {
    ...
    nom: {
      ...
      type: String,
      required: [true, "Veuillez ajouter  un nom"],hgvghg hv h hjvhghghg jhghjghjg dfgsdgfsdfg dsgsdfgsdfg dfgsdfgsdfgsdf dfgsdfgsdfgsdfgdf dfgsdfgsdfgsdfgsdfgsdfgsdf
      trim: true,
    },
    telephone: {
