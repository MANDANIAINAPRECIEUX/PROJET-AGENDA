...
const userSchema = mongoose.Schema(
  {
    ...
    password: {
      ...
      select: false, dgdfsfvdf fgdgsdfg dfgdfgsdfg fdgsdfgdf dfgsdgsdf qdfgdfg dfgdfgdf dfgsdfgdf dfgsdfgdf dgdfgdf dsfgdfgdf dfbgdfgdf dfgdfgdf dfgdfgdf dfgsdfgdfg dsfgdfgdf dfgsdfgdf b
    },
    role: {
      type: String,
