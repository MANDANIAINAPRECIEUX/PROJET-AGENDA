...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Overlay effects that match the green gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-green-400/20 via-emerald-400/20 to-teal-500/20"></div>
      
      {/* Floating elements matching the green color scheme */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-green-300/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-emerald-300/10 rounded-full blur-3xl animate-float-delayed"></div>
        <div className="absolute bottom-1/4 left-1/3 w-48 h-48 bg-teal-300/10 rounded-full blur-2xl animate-float-slow"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          <div className="flex justify-center mb-6">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-600 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-300"></div>
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 shadow-2xl transform group-hover:scale-105 transition-all duration-300">
          ...
          <div className="flex items-center justify-center gap-2 mt-2 text-white/80">
            ...
            <span className="text-sm">Inscription sécurisée</span>
          </div>
        </div>
        ...
        <Card className="shadow-2xl border-0 bg-white/10 backdrop-blur-xl border border-white/20 overflow-hidden animate-fade-in-up animation-delay-200">
          ...
          <CardContent className="relative space-y-6 pb-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {registrationMessage && (
                <div className={`p-4 text-sm rounded-xl backdrop-blur-sm animate-fade-in ${
                  isSuccess
                    ? "text-green-100 bg-green-500/20 border border-green-400/30"
                    : "text-red-100 bg-red-500/20 border border-red-400/30 animate-shake"
                }`}>
                  <div className="flex items-center gap-2">
                    <div className={`w-2 h-2 rounded-full ${isSuccess ? 'bg-green-400' : 'bg-red-400'}`}></div>
                    {registrationMessage}
                  </div>
                </div>
              )}

              {/* Enhanced Name and Surname */}
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-green-500/20 via-emerald-500/20 to-teal-600/20 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-300"></div>
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-white/80 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
              ...
              <div className="text-center pt-6 border-t border-white/20">
                <p className="text-sm text-white/80">
                  ...
                  <Link
                    to="/login"
                    className="font-semibold text-green-200 hover:text-white transition-colors hover:underline"
                  >
                    Se connecter
                  </Link>
                </p>
        ...
        <div className="text-center mt-8 text-white/80 animate-fade-in-up animation-delay-400">
          <div className="flex justify-center items-center gap-2 mb-3">
            ...
            <p className="text-sm font-medium">En créant un compte, vous acceptez nos conditions d'utilisation</p>
            <Heart className="h-4 w-4 text-green-300" />
          </div>
